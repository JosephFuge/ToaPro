...
public partial class ToaProContext : IdentityDbContext<ToaProUser, IdentityRole, string>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //        .WithMany() // or .WithMany(u => u.Logins) if you have a navigation property
        ...
        //    // If you need to map it to a custom table name
        ...
        //    //b.ToTable("AspNetUserRoles");  // If you want to specify the table name
        //});

        //modelBuilder.Entity<IdentityUserToken<string>>(b =>
        //{
        //    b.HasKey(userToken => new { userToken.UserId, userToken.LoginProvider, userToken.Name });
        //    b.ToTable("AspNetUserTokens");  // Specify the table name if you want
        //});
